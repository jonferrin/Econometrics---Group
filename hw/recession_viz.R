...
my_data2 <- read_csv('C:/Users/jscot/Documents/Econometrics---Group-master/Econometrics---Groupbcdc1.csv')

data1 <- read_csv('C:/Users/jscot/Documents/Econometrics---Group/bcdc1.csv')
